    ...
    <>
      <style>{`
        ...
        @media(max-width:640px){
          .wdev-hero { padding:6.5rem 1rem 4rem; }
        }
        ...
        .wdev-corner--bl{bottom:112px;left:260px;border-bottom:1px solid #f97316;border-left:1px solid #f97316;}
        @media(max-width:480px){ .wdev-corner--bl{ left:24px; } }
