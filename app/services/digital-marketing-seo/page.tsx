...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${BASE}/services/digital-marketing-seo` },
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "Digital Marketing & SEO Services | SEO, PPC, Social Media, Content & More - 99 Visual Solutions",
    description:
      "From SEO and PPC to Meta Ads, content marketing, email campaigns, local SEO, link building, marketing automation, and promotional videos — 99 Visual Solutions delivers data-driven digital marketing strategies that grow your traffic, leads, and revenue worldwide.",
  ...
  twitter: {
    ...
    description:
      "SEO, PPC, Meta Ads, social media, content marketing, email automation & promotional video — performance-driven digital marketing by 99 Visual Solutions.",
    // Aligned with the handle used across the rest of the site
    site: "@99VisualSoluti1",
    creator: "@99VisualSoluti1",
    images: [`${BASE}/images/services/digital-marketing-og.jpg`],
  },
};
...
const dmBreadcrumb = breadcrumb([
  { name: "Home", url: "/" },
  { name: "Services", url: "/services" },
  { name: "Digital Marketing & SEO", url: "/services/digital-marketing-seo" },
]);

const dmWebPage = webPage({
  url: "/services/digital-marketing-seo",
  name: "Digital Marketing & SEO Services | SEO, PPC, Social Media, Content & More - 99 Visual Solutions",
  description:
    "Full-spectrum digital marketing: SEO, PPC, Meta Ads, social media, content & email marketing, local SEO, link building, marketing automation, and promotional video by 99 Visual Solutions.",
});

const dmFaq = faqSchema([
  {
    question: "What digital marketing services does 99 Visual Solutions offer?",
    answer:
      "We offer SEO (on-page, off-page, technical, local), PPC advertising, Meta Ads, social media marketing, content marketing, email marketing & automation, link building, on-page optimization, creative banner design, and promotional video production.",
  },
  {
    question: "Do you manage Google Ads and Meta Ads campaigns?",
    answer:
      "Yes. We manage end-to-end PPC campaigns on Google Ads as well as paid social campaigns on Facebook, Instagram, and LinkedIn, including strategy, creative, targeting, and continuous optimization.",
  },
  {
    question: "What is MindTrick.io?",
    answer:
      "MindTrick.io is our dedicated digital marketing hub focused on delivering result-oriented, data-driven marketing solutions — from performance marketing to brand storytelling — for businesses looking to grow online.",
  },
  {
    question: "How do you measure digital marketing performance?",
    answer:
      "We track key metrics including organic traffic, keyword rankings, conversion rates, cost per lead, ROAS, and engagement rates. We provide regular reporting and use analytics insights for continuous campaign optimization.",
  },
]);
  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(dmBreadcrumb) }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(dmWebPage) }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(dmFaq) }}
      />
      ...
      <style>{`
        ...
        .dm-hero__orb {
          ...
          animation: dmOrbDrift 16s ease-in-out infinite alternate;
          pointer-events: none;
        }
        .dm-hero__orb--1 {
        ...
        .dm-hero__breadcrumb {
          ...
          margin-bottom: 2rem;
          animation: dmFadeUp .9s cubic-bezier(.22,1,.36,1) .05s both;
        }
        .dm-hero__breadcrumb a {
          color: #f97316; text-decoration: none; font-weight: 500;
        }
        .dm-hero__breadcrumb a:hover { text-decoration: underline; }
        .dm-hero__breadcrumb span { opacity: .4; }

        .dm-hero__content {
          position: relative; z-index: 10; max-width: 860px; margin: 0 auto;
          animation: dmFadeUp .9s cubic-bezier(.22,1,.36,1) both;
        }
        @keyframes dmFadeUp {
        ...
        .dm-hero__eyebrow {
          ...
          animation: dmFadeUp .9s cubic-bezier(.22,1,.36,1) .1s both;
        }
        .dm-hero__dot {
        ...
        .dm-hero__h1 {
          ...
          animation: dmFadeUp .9s cubic-bezier(.22,1,.36,1) .18s both;
        }
        ...
        .dm-hero__rule {
          ...
          animation: dmFadeUp .9s cubic-bezier(.22,1,.36,1) .26s both;
        }
        .dm-hero__sub {
          ...
          animation: dmFadeUp .9s cubic-bezier(.22,1,.36,1) .34s both;
        }
        .dm-hero__cta {
          ...
          animation: dmFadeUp .9s cubic-bezier(.22,1,.36,1) .44s both;
        }
        ...
        .dm-hero__scroll {
          ...
          animation: dmFadeUp .9s ease .8s both;
        }
        .dm-hero__scroll-line {
          width: 1px; height: 40px;
          background: linear-gradient(to bottom, rgba(255,255,255,.3), transparent);
          animation: dmScrollLine 1.8s ease-in-out infinite;
        }
        @keyframes dmScrollLine {
        ...
        @media (max-width: 768px) {
          .dm-svc__inner--img-left,
          .dm-svc__inner--img-right { grid-template-columns: 1fr; gap: 2.5rem; }
          .dm-svc__img-wrap { order: 2 !important; }
          .dm-svc__body    { order: 1 !important; }
        }

        .dm-svc__img-wrap {
          position: relative; border-radius: 16px; overflow: hidden;
        }
        .dm-svc__img-wrap::before {
          content: ''; position: absolute; inset: 0; z-index: 1;
          background: linear-gradient(135deg, rgba(249,115,22,.08), transparent 60%);
          border-radius: 16px;
        }
        .dm-svc__img-wrap img {
      ...
      {/* ══ HERO ══════════════════════════════════════════════ */}
      <section className="dm-hero" aria-label="Digital Marketing & SEO Services Hero">
  ...
  <span aria-current="page" style={{ color: "rgba(255,255,255,0.5)" }}>
    Digital Marketing & SEO
        ...
        <div className="dm-hero__content">
          ...
          <a href="#services" className="dm-hero__cta">
            Explore Services
        ...
        <a href="#services" className="dm-hero__scroll" aria-label="Scroll to services">
      ...
      <div id="services" className="dm-services">
        {services.map((svc, idx) => (
          <section
            ...
            id={svc.id}
            className="dm-svc"
            aria-labelledby={`dm-svc-heading-${svc.id}`}
          >
            <div className={`dm-svc__inner--img-${svc.imageLeft ? "left" : "right"}`}>
              {/* Image */}
              <div
                className="dm-svc__img-wrap"
              ...
              {/* Text */}
              <div
                className="dm-svc__body"
                style={{ order: svc.imageLeft ? 2 : 1 }}
              >
                <span className="dm-svc__num" aria-hidden="true">
                  {String(idx + 1).padStart(2, "0")}
                </span>
                <span className="dm-svc__eyebrow">
                  Service {String(idx + 1).padStart(2, "0")}
                </span>
                <h2
                  className="dm-svc__h3"
                  id={`dm-svc-heading-${svc.id}`}
                >
                  {svc.title}
                </h2>
      ...
      <section className="dm-cta" aria-labelledby="dm-cta-heading">
        ...
        <div className="dm-cta__inner">
          ...
          <p className="dm-cta__sub">
            ...
            map out the right digital marketing strategy for your goals.
          </p>
          <Link href="/contact" className="dm-cta__btn">
