...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      "en-IN":     `${BASE}/services/digital-marketing-seo`,
      "en-US":     `${BASE}/services/digital-marketing-seo`,
      "en-GB":     `${BASE}/services/digital-marketing-seo`,
      "en-AE":     `${BASE}/services/digital-marketing-seo`,
      "en-AU":     `${BASE}/services/digital-marketing-seo`,
      "x-default": `${BASE}/services/digital-marketing-seo`,
    },
  },
  ...
  openGraph: {
    title: "Digital Marketing & SEO Services | SEO, PPC, Social Media & More - 99 Visual Solutions",
    description:
      "From SEO and PPC to Meta Ads, content marketing, email campaigns, local SEO, link building, marketing automation, and promotional videos — 99 Visual Solutions delivers data-driven digital marketing that grows your traffic, leads, and revenue worldwide.",
    url: `${BASE}/services/digital-marketing-seo`,
    siteName: "99 Visual Solutions",
    images: [{ url: `${BASE}/images/services/digital-marketing-og.jpg`, width: 1200, height: 630, type: "image/jpeg", alt: "Digital Marketing & SEO Services by 99 Visual Solutions" }],
    locale: "en_US",
    type: "website",
  },
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .dm-hero__scroll { position: absolute; bottom: 2rem; left: 50%; transform: translateX(-50%); z-index: 20; display: flex; flex-direction: column; align-items: center; gap: 6px; text-decoration: none; animation: dmFadeUp .9s ease .8s both; }
        .dm-hero__scroll-line { width: 1px; height: 40px; background: linear-gradient(to bottom, rgba(255,255,255,.3), transparent); animation: dmScrollLine 1.8s ease-in-out infinite; }
        @keyframes dmScrollLine { 0% { transform: scaleY(0); transform-origin: top; opacity: 1; } 50% { transform: scaleY(1); transform-origin: top; opacity: 1; } 100% { transform: scaleY(1); transform-origin: bottom; opacity: 0; } }
        .dm-hero__scroll-lbl { font-family: 'DM Sans', sans-serif; font-size: 9px; font-weight: 500; letter-spacing: .2em; text-transform: uppercase; color: rgba(255,255,255,.22); }
      ...
      <section className="dm-intro" aria-labelledby="dm-intro-heading">
        <div className="dm-intro__inner">
          ...
          <p className="dm-intro__p">
            ...
            <strong>digital marketing strategies</strong> that not only attract audiences but convert them into loyal customers.
            Our holistic approach ensures your brand achieves <strong>maximum online visibility and sustainable growth</strong>.
          </p>
          <p className="dm-intro__p">
            From <strong>SEO and content marketing</strong> to <strong>social media campaigns and paid advertising</strong>,
            our solutions are tailored to your business goals — helping you stay ahead in today's competitive digital landscape.
          </p>
        </div>
      </section>
      ...
      <section className="dm-cta" aria-labelledby="dm-cta-heading">
        ...
        <div className="dm-cta__inner">
          ...
          <h2 className="dm-cta__h2" id="dm-cta-heading">Ready to grow your brand <em>online</em>?</h2>
          <div className="dm-cta__rule" aria-hidden="true" />
          <p className="dm-cta__sub">
            Get in touch with our team for a free consultation. We'll help you map out the right digital
            marketing strategy for your goals.
          </p>
