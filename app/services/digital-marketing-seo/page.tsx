  ...
  return (
    <>
      <style>{`
        ...
        .dm-hero__sub{font-family:'Inter',sans-serif;font-size:clamp(.92rem,1.6vw,1.05rem);font-weight:300;line-height:1.8;color:rgba(255,255,255,0.78);max-width:560px;margin:0 0 2.6rem;animation:dmFadeUp .9s cubic-bezier(.22,1,.36,1) .34s both;text-shadow:0 1px 12px rgba(0,0,0,.4);}
        @media(max-width:960px){.dm-hero__sub{margin:0 auto 2.6rem;}}
      ...
      <div className="dm-page">
          ...
          <div className="dm-hero__inner">
            <div className="dm-hero__content">
              ...
              <div className="dm-hero__ctas">
                ...
                <ConsultationCTA className="dm-hero__cta dm-hero__cta--ghost" ariaLabel="Get a free digital marketing consultation">
        ...
        <section className="dm-cta" aria-labelledby="dm-cta-heading">
          <div className="dm-cta__inner">
            ...
            <ConsultationCTA className="dm-cta__btn" ariaLabel="Get a free digital marketing consultation from 99 Visual Solutions">
              Get a Free Consultation
        ...
        <div className="dm-sticky-cta">
          <ConsultationCTA className="dm-sticky-cta__btn">Get a Free Quote</ConsultationCTA>
        </div>
      </div>
