    ...
    <>
      ...
      <style>{`
        ...
        @media(max-width:640px){
          .cg-hero { padding:6.5rem 1rem 4rem; }
        }
        @media(max-width:960px) and (orientation:landscape){
          .cg-hero { min-height:100vh;padding-top:5.5rem;padding-bottom:3rem; }
        }
        ...
        .cg-corner--bl{bottom:112px;left:260px;border-bottom:1px solid #f97316;border-left:1px solid #f97316;}
        @media(max-width:480px){ .cg-corner--bl{ left:24px; } }
