...
export const metadata: Metadata = {
  title:
    "Our Services | Web Development, AI QA, Digital Marketing, IT Consulting & More — 99 Visual Solutions",
  description:
    "Explore 99 Visual Solutions' full range of services: custom web development, AI-powered QA & automation testing, digital marketing & SEO, IT consulting, 3D visualization, CAD/GIS/photogrammetry. Trusted by startups and enterprises worldwide.",
  ...
  openGraph: {
    title:
      "Our Services | Web Development, AI QA, Digital Marketing & More — 99 Visual Solutions",
    description:
      "Full-spectrum technology and creative services: web development, AI-powered QA testing, digital marketing & SEO, IT consulting, 3D visualization, and CAD/GIS/photogrammetry — all under one roof.",
    url: `${BASE}/services`,
  ...
  twitter: {
    ...
    description:
      "Web development, AI QA testing, digital marketing, IT consulting, 3D visualization, and CAD/GIS — explore all services by 99 Visual Solutions.",
...
const svPageNode = {
  ...
  url:           `${BASE}/services`,
  name:          "Our Services | Web Development, AI QA, Digital Marketing & More — 99 Visual Solutions",
  description:
    "Full-spectrum technology and creative services: web development, AI QA testing, digital marketing & SEO, IT consulting, 3D visualization, and CAD/GIS/photogrammetry.",
  inLanguage:    "en",
...
const services = [
  {
    ...
    description:
      "Custom web applications, front-end & back-end engineering, UX design, e-commerce, CMS, SEO optimization, API integrations, and security — built to perform at every scale.",
  ...
  },
  {
    ...
    description:
      "Full-spectrum digital marketing: SEO, PPC, Meta Ads, social media, content marketing, email automation, local SEO, link building, and promotional video — engineered for ROI.",
  ...
  },
  {
    ...
    description:
      "Next-generation quality assurance powered by Agentic AI — autonomous test agents, self-healing automation, LLM-driven exploratory testing, performance, security, and CI/CD integration.",
  ...
  },
  {
    ...
    title:       "IT Consulting",
    description:
      "End-to-end IT consulting: infrastructure planning, cloud migration (AWS, Azure, GCP), cybersecurity, IoT integration, software consulting, and IT project management.",
  ...
  },
  {
    ...
    description:
      "Photorealistic architectural renders, immersive 3D walkthroughs, product visualization, precision CAD modeling, BIM, and LiDAR data processing — turning concepts into stunning realities.",
  ...
  },
  {
    ...
    description:
      "Precision-driven CAD drafting, GIS mapping, drone & aerial photogrammetry, LiDAR processing, spatial analysis, and 3D modeling for infrastructure, engineering, and urban planning worldwide.",
    ...
    <>
      ...
      <style>{`
        ...
        .sv-hero {
          ...
          padding: 9rem 1.5rem 7rem; text-align: center;
        }
        .sv-hero__orb {
          position: absolute; border-radius: 50%; filter: blur(110px);
          animation: svOrbDrift 18s ease-in-out infinite alternate;
          pointer-events: none;
        }
        .sv-hero__orb--1 {
          width: 600px; height: 600px;
          background: radial-gradient(circle, #6366f1, #4f46e5);
          top: -200px; left: -140px; opacity: .11;
        }
        .sv-hero__orb--2 {
          width: 500px; height: 500px;
          background: radial-gradient(circle, #f97316, #ea580c);
          bottom: -160px; right: -100px; opacity: .10;
          animation-delay: -9s;
        }
        .sv-hero__orb--3 {
          width: 340px; height: 340px;
          background: radial-gradient(circle, #06b6d4, #0891b2);
          top: 35%; right: 12%; opacity: .065;
          animation-delay: -4.5s;
        }
        .sv-hero__orb--4 {
          width: 280px; height: 280px;
          background: radial-gradient(circle, #a855f7, #7c3aed);
          top: 60%; left: 8%; opacity: .06;
          animation-delay: -7s;
        }
        @keyframes svOrbDrift {
          0%   { transform: translate(0,0) scale(1); }
          100% { transform: translate(28px,20px) scale(1.07); }
        }
        .sv-hero__grid {
        ...
        .sv-corner {
          ...
          z-index: 5; opacity: .18; pointer-events: none;
        }
        ...
        .sv-hero__content {
          ...
          animation: svFadeUp .9s cubic-bezier(.22,1,.36,1) both;
        }
        @keyframes svFadeUp {
        ...
        .sv-hero__eyebrow {
          ...
          animation: svFadeUp .9s cubic-bezier(.22,1,.36,1) .1s both;
        }
        .sv-hero__dot {
        ...
        .sv-hero__h1 {
          ...
          animation: svFadeUp .9s cubic-bezier(.22,1,.36,1) .18s both;
        }
        .sv-hero__h1 em {
        ...
        .sv-hero__rule {
          ...
          animation: svFadeUp .9s cubic-bezier(.22,1,.36,1) .26s both;
        }

        .sv-hero__sub {
          font-family: 'DM Sans', sans-serif;
          font-size: clamp(1rem, 2.2vw, 1.15rem);
          font-weight: 300; line-height: 1.85; color: rgba(255,255,255,0.42);
          max-width: 700px; margin: 0 auto 3rem;
          animation: svFadeUp .9s cubic-bezier(.22,1,.36,1) .34s both;
        }
        ...
        .sv-hero__actions {
          ...
          align-items: center; justify-content: center;
          animation: svFadeUp .9s cubic-bezier(.22,1,.36,1) .44s both;
        }
        ...
        .sv-intro__p {
          ...
          font-weight: 300; line-height: 1.85; color: rgba(255,255,255,0.42);
          max-width: 660px; margin: 0 auto .9rem;
        }
        ...
        /* top accent line — colour injected via inline style on ::before pseudo via data attr trick */
        .sv-card::before {
          content: '';
          position: absolute; top: 0; left: 0; right: 0; height: 2px;
          background: var(--sv-accent, #f97316);
          opacity: 0;
        ...
        .sv-card:hover {
          ...
          border-color: color-mix(in srgb, var(--sv-accent, #f97316) 35%, transparent);
        ...
        .sv-card__icon-wrap {
          ...
          background: color-mix(in srgb, var(--sv-accent, #f97316) 12%, transparent);
          border: 1px solid color-mix(in srgb, var(--sv-accent, #f97316) 25%, transparent);
          display: flex; align-items: center; justify-content: center;
          color: var(--sv-accent, #f97316); font-size: 1.15rem;
          transition: background .3s ease;
        }
        .sv-card:hover .sv-card__icon-wrap {
          background: color-mix(in srgb, var(--sv-accent, #f97316) 20%, transparent);
        }
        .sv-card__tag {
          font-family: 'DM Sans', sans-serif; font-size: 9px; font-weight: 500;
          letter-spacing: .18em; text-transform: uppercase;
          color: var(--sv-accent, #f97316);
          border: 1px solid color-mix(in srgb, var(--sv-accent, #f97316) 30%, transparent);
          background: color-mix(in srgb, var(--sv-accent, #f97316) 7%, transparent);
        ...
        .sv-card:hover .sv-card__title { color: #fff; }

        .sv-card__rule {
          width: 28px; height: 1px;
          background: linear-gradient(90deg, var(--sv-accent, #f97316), transparent);
          margin-bottom: 1rem;
        ...
        .sv-card__desc {
          ...
          font-weight: 300; line-height: 1.8; color: rgba(255,255,255,0.42);
        ...
        @media (max-width: 860px) {
          .sv-why__inner { grid-template-columns: 1fr; gap: 3rem; }
        }
        .sv-why__label {
          font-family: 'DM Sans', sans-serif; font-size: 10px; font-weight: 500;
          letter-spacing: .22em; text-transform: uppercase;
        ...
        .sv-why__item-icon {
          color: #f97316; font-size: 1rem; flex-shrink: 0; margin-top: .15rem;
        }
        .sv-why__item-text {
        ...
        .sv-cta__orb {
          ...
          opacity: .045; top: 50%; left: 50%; transform: translate(-50%,-50%);
        ...
        @media (max-width: 480px) {
          ...
          .sv-hero__btn--primary,
          .sv-hero__btn--ghost { justify-content: center; }
        }
      ...
      <section className="sv-hero" aria-labelledby="sv-hero-heading">
        ...
        {/* sr-only breadcrumb */}
        <nav className="sv-sr-only" aria-label="Breadcrumb" aria-hidden="true">
          <ol itemScope itemType="https://schema.org/BreadcrumbList" style={{ listStyle: "none", margin: 0, padding: 0 }}>
            ...
            <li itemScope itemProp="itemListElement" itemType="https://schema.org/ListItem">
              <a href="/services" itemProp="item" aria-current="page">
        ...
        <div className="sv-hero__content">
          ...
          <h1 className="sv-hero__h1" id="sv-hero-heading">
            ...
            built for the <em>intelligent era</em>
          </h1>
          ...
          <div className="sv-hero__actions">
            <a
              href="#sv-grid"
              className="sv-hero__btn--primary"
              aria-label="Browse all 99 Visual Solutions services"
            >
              Browse Services
            ...
            <Link
              href="/contact"
              className="sv-hero__btn--ghost"
              aria-label="Contact 99 Visual Solutions"
            >
          ...
          {stats.map((s) => (
            <div key={s.label}>
              <div className="sv-stat__val">
                {s.value.replace(/\d+/, (n) => `${n}`).split("+").map((part, i, arr) =>
                  i < arr.length - 1
                    ? <span key={i}>{part}<span style={{ color: "#f97316" }}>+</span></span>
      ...
      <section className="sv-intro" aria-labelledby="sv-intro-heading">
        <div className="sv-intro__inner">
          ...
          <h2 className="sv-intro__h2" id="sv-intro-heading">
            One partner.<br />
            The <em>full spectrum</em> of modern technology.
          </h2>
      ...
      <section
        ...
        aria-labelledby="sv-services-heading"
      >
            ...
            {services.map((svc) => (
              ...
              >
                <div className="sv-card__top">
                  <div className="sv-card__icon-wrap" aria-hidden="true">
                    {svc.icon}
                  </div>
        ...
        <div className="sv-why__inner">
          ...
          <div>
            ...
            <Link
              ...
              aria-label="Start a project with 99 Visual Solutions"
            >
              Start a Project
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                <path d="M2 7h10M8 3l4 4-4 4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
      ...
      <section className="sv-cta" aria-labelledby="sv-cta-heading">
        ...
        <div className="sv-cta__inner">
          ...
          <Link
            href="/contact"
            className="sv-cta__btn"
            aria-label="Get a free consultation from 99 Visual Solutions"
          >
            Get a Free Consultation
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
              <path d="M2 7h10M8 3l4 4-4 4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
