    ...
    <>
      ...
      <style>{`
        ...
        .pt-hero__eyebrow {
          ...
          animation:       ptFadeUp .9s cubic-bezier(.22,1,.36,1) both;
        }
        .pt-hero__dot {
          width:         5px;
          height:        5px;
        ...
        .pt-hero__h1 {
          ...
          color:          #fff;
          margin:         0 0 1rem;
          animation:      ptFadeUp .9s cubic-bezier(.22,1,.36,1) .12s both;
        }
        .pt-hero__h1 em {
          font-style:          italic;
          color:               transparent;
        ...
        .pt-hero__rule {
          ...
          margin:     0 0 1.4rem;
          animation:  ptFadeUp .9s cubic-bezier(.22,1,.36,1) .22s both;
        }
        ...
        .pt-hero__sub {
          ...
          max-width:   420px;
          margin:      0 0 2rem;
          animation:   ptFadeUp .9s cubic-bezier(.22,1,.36,1) .32s both;
        }
        ...
        .pt-hero__cta-group {
          ...
          gap:       12px;
          flex-wrap: wrap;
          animation: ptFadeUp .9s cubic-bezier(.22,1,.36,1) .44s both;
        }
        ...
        .pt-globe {
          ...
          animation:       ptGlobePulse 4s ease-in-out infinite;
          z-index:         10;
          display:         flex;
          align-items:     center;
          justify-content: center;
        }
        @keyframes ptGlobePulse {
          0%,100% { box-shadow: 0 0 40px rgba(249,115,22,.15), 0 0 80px rgba(249,115,22,.06), inset 0 1px 0 rgba(255,255,255,.07); }
        ...
        .p-section-label {
          ...
          letter-spacing:.22em;text-transform:uppercase;color:var(--c-orange);margin-bottom:.8rem;display:block;
        }
        .p-section-h2 {
        ...
        .p-type-card {
          ...
          padding:2.4rem 2rem;transition:background .25s ease;
        }
        ...
        .p-why__stat-num {
          ...
          font-weight:700;color:var(--c-orange);line-height:1;margin-bottom:4px;display:block;
        }
        .p-why__stat-label {
          font-family:var(--ff-sans);font-size:10px;font-weight:500;
          letter-spacing:.15em;text-transform:uppercase;color:var(--c-muted);display:block;
        }
        ...
        .p-faq__item {
          ...
          background:var(--c-bg);transition:background .2s ease;
        }
        ...
        .p-faq__q-text {
          ...
          color:rgba(255,255,255,.85);line-height:1.35;flex:1;transition:color .2s ease;
        }
        ...
        .p-faq__a {
          ...
          animation:ptFaqOpen .3s cubic-bezier(.22,1,.36,1) both;
        }
        ...
        .p-cta__h2 {
          ...
          font-weight:700;line-height:1.05;letter-spacing:-.02em;color:#fff;margin-bottom:1.2rem;
        }
        ...
        @media (max-width: 900px) {
          ...
          .pt-anim        { width: 260px; height: 320px; }
        }
      ...
      >
        ...
        <div className="pt-hero__left">
          ...
          <h1 className="pt-hero__h1" id="pt-hero-heading" itemProp="name">
            Grow <em>together</em><br />with us
          </h1>

          <div className="pt-hero__rule" aria-hidden="true" />

          <p className="pt-hero__sub" itemProp="description">
          ...
          <div className="pt-hero__cta-group">
            <a
              href="#partner-types"
              className="pt-hero__cta-primary"
            ...
            <Link
              href="/contact"
              className="pt-hero__cta-secondary"
        ...
        {/* ── RIGHT: orbiting partnership nodes animation ──────────────────── */}
        <div className="pt-hero__right" aria-hidden="true">
          <div className="pt-anim">
            ...
            <div className="pt-node pt-node--o1b">
              <FaGlobe />
            </div>
            ...
            <div className="pt-node pt-node--o2b">
              <FaLightbulb />
            </div>
