...
const TestingDevelopmentBanner = () => {
  const swirlBackground: CSSProperties = {
    backgroundImage: `
  ...
  useEffect(() => {
    const generatedParticles: Particle[] = Array.from({ length: 50 }).map(() => ({
      top: `${Math.random() * 100}%`,
...
export default TestingDevelopmentBanner;
