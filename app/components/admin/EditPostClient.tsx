...
export default function EditPostClient({ post, categories, authors, tags }: Props) {
  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-white text-2xl font-semibold">Edit Post</h1>
          <p className="text-gray-400 text-sm mt-1 font-mono">/insights/{slug}</p>
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-800 border border-gray-700 rounded-xl pl-10 pr-3 py-2.5 text-white text-sm focus:outline-none focus:border-orange-500"
                  />
                </div>
              </div>
            </div>
